      ...
      <div class="row">
        ...
        <br/>
            ...
            <div class="box-header">
              <!-- tools box -->
             <h3 class="box-title"><strong>사내소식 등록</strong></h3>
	<br/>
 	<div class="box box-info"></div>
            ...
            <div class="box-body pad">
              ...
              <form action="workNewsWrite" method="post" enctype="multipart/form-data" onsubmit="return check();">
              
            <table>
            	<tr>
            	<td style="width: 100px; text-align: center;"><strong>제목</strong></td>
            	<td><input type="text" onkeyup="getBytes(100)" style="width: 1200px;" class="form-control" id="inputName" name="br_tt" placeholder="workNewsTitle"><span id="maxByte">0/100Byte</span></td>
